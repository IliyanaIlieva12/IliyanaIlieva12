...
{
    public partial class Tattoo : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tattoos_Categories_CategorieId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rezervations_AspNetUsers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Rezervations_Employers_EmployerId",
                        column: x => x.EmployerId,
                        principalTable: "Employers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Rezervations_Tattoos_TattooId",
                        column: x => x.TattooId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rezervations_EmployerId",
                table: "Rezervations",
                column: "EmployerId");

            migrationBuilder.CreateIndex(
                name: "IX_Rezervations_TattooId",
                table: "Rezervations",
                column: "TattooId");

            migrationBuilder.CreateIndex(
                name: "IX_Tattoos_CategorieId",
                table: "Tattoos",
                column: "CategorieId");
        }
